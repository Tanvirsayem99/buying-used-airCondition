...
import { PHONE_NUMBER, WHATSAPP_NUMBER, getWhatsAppUrl } from "@/app/data/content";
...
export const FloatingCTA = () => {
  ...
  const mobileWhatsappMessage =
    lang === "ar"
      ? "السلام عليكم، لدي مكيفات/أجهزة مستعملة في القطيف وأرغب في الحصول على تقييم فوري."
      : "Hello, I have used ACs/appliances in Qatif and would like an instant quote.";

  return (
    <>
      {/* Floating Interactive WhatsApp Chat Popup System */}
      <WhatsAppChatPopup phoneNumber={WHATSAPP_NUMBER} lang={lang} />
      ...
      <div className="fixed bottom-0 left-0 right-0 z-40 sm:hidden bg-[#070d1e]/95 backdrop-blur-md border-t border-cyan-500/30 p-3 shadow-2xl">
        <div className="grid grid-cols-2 gap-3">
          ...
          <a
            href={getWhatsAppUrl(WHATSAPP_NUMBER, mobileWhatsappMessage)}
            target="_blank"
